...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20240917204633_ChangedSomeFieldsToValueObjects")]
    partial class ChangedSomeFieldsToValueObjects
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Aggregates.Volunteer.Entities.Pet", b =>
                {
                            ...
                            b1.OwnsMany("Domain.Aggregates.Volunteer.ValueObjects.Requisite", "Values", b2 =>
                                {
                                    ...
                                    b2.OwnsOne("Domain.Aggregates.Volunteer.ValueObjects.Description", "Description", b3 =>
                                        {
                                    ...
                                    b2.OwnsOne("Domain.Aggregates.Volunteer.ValueObjects.Name", "Name", b3 =>
                                        {
                                            b3.Property<Guid>("RequisiteValueObjectListPetId")
                                                .HasColumnType("uuid");
                    ...
                    b.OwnsOne("Domain.Aggregates.Volunteer.ValueObjects.ValueObjectList<Domain.Aggregates.Volunteer.ValueObjects.PetPhoto>", "PetPhotos", b1 =>
                        {
                            b1.Property<Guid>("PetId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
            ...
            modelBuilder.Entity("Domain.Aggregates.Volunteer.Volunteer", b =>
                {
                    ...
                    b.OwnsOne("Domain.Aggregates.Volunteer.ValueObjects.ValueObjectList<Domain.Aggregates.Volunteer.ValueObjects.SocialNetwork>", "SocialNetworks", b1 =>
                        {
                            b1.Property<Guid>("VolunteerId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("Domain.Aggregates.Volunteer.ValueObjects.ValueObjectList<Domain.Aggregates.Volunteer.ValueObjects.Requisite>", "Requisites", b1 =>
                        {
                            b1.Property<Guid>("VolunteerId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
