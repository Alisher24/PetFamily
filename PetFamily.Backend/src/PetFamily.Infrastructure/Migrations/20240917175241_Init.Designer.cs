            ...
            modelBuilder.Entity("Domain.Aggregates.Volunteer.Entities.Pet", b =>
                {
                    ...
                    b.OwnsOne("Domain.CommonFields.ValueObjectList<Domain.Aggregates.Volunteer.ValueObjects.PetPhoto>", "PetPhotos", b1 =>
                        {
                            b1.Property<Guid>("PetId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
            ...
            modelBuilder.Entity("Domain.Aggregates.Volunteer.Volunteer", b =>
                {
                    ...
                    b.OwnsOne("Domain.CommonFields.ValueObjectList<Domain.Aggregates.Volunteer.ValueObjects.Requisite>", "Requisites", b1 =>
                        {
                            b1.Property<Guid>("VolunteerId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("Domain.CommonFields.ValueObjectList<Domain.Aggregates.Volunteer.ValueObjects.SocialNetwork>", "SocialNetworks", b1 =>
                        {
                            b1.Property<Guid>("VolunteerId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
